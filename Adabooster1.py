...
def find_TP_FN_FP_TN(p_of_class_a, p_attr_with_class_a_dict, p_of_class_b, p_attr_with_class_b_dict, dataset, finalVal):
...
def computeClassifier(range_of_attr, dataset, currentRound):
    ...
    error_list = find_TP_FN_FP_TN(p_of_class_a, p_attr_with_class_a_dict, p_of_class_b, p_attr_with_class_b_dict, dataset, False)
    ...
    while currentRound < k:
        ...
        while 1:
            ...
            while i < random_sample:
                random_number = randrange(len(test_data))
